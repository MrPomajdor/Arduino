...
const char *SSID = "CMCC-F5vr";
const char *PASSWORD = "karolincia08";

// Your ESP Wifi
const char *SOFT_AP_SSID = "Podsiadlik-WiFi";
const char *SOFT_AP_PASSWORD = "karolinka"; // My preference is same as my home SSID PASSWORD.
